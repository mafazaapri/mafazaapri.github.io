...
export default function AboutPage() {
 ...
 I enjoy discussing product-ideas    </span>
  ...
  little details
          ...
          <br/>
            Currently I'm a UX designer at  <span className="font-neuton italic"> <a href="https://www.becurious.co/">Becurious Studio</a> </span> where I collaborate with PM, stakeholders, <br/> and team of designers to help clients achieve their goal <img src="/img/sprinkle.png" className="w-8 inline-block ms-2" /> <br/><br/>
